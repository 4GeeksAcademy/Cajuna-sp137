...
export const PermitRequestCreate = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      const res = await fetch(import.meta.env.VITE_BACKEND_URL + "/api/permit-requests", {
        method: "POST",
    ...
    <div className="container mt-4">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <textarea name="reason" value={form.reason} onChange={handleChange} className="form-control" rows="2" required />
        </div>
        <div>
