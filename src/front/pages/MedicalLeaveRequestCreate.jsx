...
export const MedicalLeaveRequestCreate = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      const res = await fetch(import.meta.env.VITE_BACKEND_URL + "/api/medical-leave-requests", {
        method: "POST",
      ...
      if (res.ok) navigate("/medical-leave-requests")
        ...
        console.error("Error creating medical leave request:", err)
      }
    } catch (error) {
  ...
  return (
    <div className="container mt-4">
      <h1>New Medical Leave Request</h1>
