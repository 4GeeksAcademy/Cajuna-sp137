...
export const MedicalLeaveRequestDetail = () => {
    const { id } = useParams()
    ...
    return (
        <div className="container mt-4">
            <h1>Medical Leave Request #{req.id}</h1>
            <div className="card mb-3">
                <div className="card-body">
                    <dl className="row">
                        ...
                        <dd className="col-sm-9">{req.document || "—"}</dd>
                    </dl>
                </div>
            </div>

            <div className="mt-3">
                <Link to="/medical-leave-requests" className="btn btn-secondary">Back to list</Link>
                <Link to={`/medical-leave-requests/${req.id}/edit`} className="btn btn-warning ms-2">Edit</Link>
                <Link to={`/medical-leave-requests/${req.id}/delete`} className="btn btn-danger ms-2">Delete</Link>
            </div>
        </div>
    )
}
